    ...
    <div class="head-container">
      ...
      >
        ...
        >
          ...
          <el-form-item label="mResidual">
            <el-input v-model="form.mResidual" style="width: 370px" />
          </el-form-item>
      ...
      >
        ...
        <el-table-column
          v-if="checkPer(['admin', 'dcHvArrester:edit', 'dcHvArrester:del'])"
          label="操作"
          width="150px"
          align="center"
        >
...
<script>
import crudDcHvArrester from "@/api/dcHvArrester";
...
export default {
  ...
  cruds() {
    return CRUD({
      ...
      idField: "id",
      sort: "id,desc",
      crudMethod: { ...crudDcHvArrester },
    });
  },
  data() {
    return {
      permission: {
        add: ["admin", "dcHvArrester:add"],
        edit: ["admin", "dcHvArrester:edit"],
        del: ["admin", "dcHvArrester:del"],
      },
      rules: {},
      queryTypeOptions: [
