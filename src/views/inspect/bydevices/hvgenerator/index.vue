    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="mFrequency">
            <el-input v-model="form.mFrequency" style="width: 370px;" />
          </el-form-item>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','hvGenerator:edit','hvGenerator:del'])" label="操作" width="150px" align="center">
...
<script>
import crudHvGenerator from '@/api/hvGenerator'
...
const defaultForm = { id: null, username: null, deviceId: null, station: null, ssid: null, mFrequency: null, mTime: null, mVoltage: null, mCurrent: null, inspectTime: null, saveTime: null, synState: null, other1: null, other2: null, other3: null }
export default {
  name: 'HvGenerator',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '超低频高压发生器', url: 'api/hvGenerator', idField: 'id', sort: 'id,desc', crudMethod: { ...crudHvGenerator }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'hvGenerator:add'],
        edit: ['admin', 'hvGenerator:edit'],
        del: ['admin', 'hvGenerator:del']
      },
      rules: {
      },
      queryTypeOptions: [
